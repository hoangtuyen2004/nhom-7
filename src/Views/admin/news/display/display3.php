                    ...
                    <div class="td-ss-main-content">
                        <div class="td-category-grid td-container-wrap">
                            <div class="" style="display: flex;justify-content: center;">
                                <div style="width: 50%;" class="td-pb-row">
                                            ...
                                            <div id=td_uid_8_655dbcad501ed class="td_block_inner">
                                                <div  class="td-big-grid-wrapper">
                                                    <div
                                                        ...
                                                        <div>
                                                            <img class="mb" src="/img_file/<?=$new['img_1']?>"/>
                                                        </div>
                                                    </div>
...
<!-- IMG -->
                <p><img style="width: 50%;object-fit: cover;" class="size-full wp-image-12643 aligncenter" src="/img_file/<?=$new['img_4']?>"/></p>
<!-- TITLE_2 -->
