...
<article id="post-12641"
    ...
    <div class="td-post-content">
        ...
        <p><img style="width: 65%;max-height:400px;object-fit:cover;" class="size-full wp-image-12643 aligncenter" src="/img_file/<?=$news['img_1']?>" /></p>
        ...
        <p><span style="font-weight: 400;"> - <?=$news['content_1']?>.</span></p>
                ...
                <p><img style="width: 65%;max-height:400px;object-fit:cover;" class="size-full wp-image-12643 aligncenter" src="/img_file/<?=$news['img_2']?>" /></p>
        ...
        <p><img style="width: 65%;max-height:400px;object-fit:cover;" class="size-full wp-image-12644 aligncenter" src="/img_file/<?=$news['img_3']?>"/></p>
        </div>
</article>
</div>