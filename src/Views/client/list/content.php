                    ...
                    <div
                        ...
                        <div class="td_block_wrap td_block_15 td_uid_28_655dbc1936fe2_rand td-pb-border-top td_block_template_1 td-column-2 td_block_padding"
                            ...
                            <div class="td-block-title-wrap">
                                <h4 class="block-title td-block-title"><span class="td-pulldown-size">TIN KHÁC</span>
                                </h4>
                            </div>

                            <div id=td_uid_28_655dbc1936fe2 class="td_block_inner td-column-2">
                                <div class="td-block-row">
                                    <?php foreach ($newAAA as $AAA) :?>
                                    <div class="td-block-span4">
                                        <div class="td_module_mx4 td_module_wrap td-animation-stack">
                                            <div class="td-module-image">
                                                <div class="td-module-thumb">
                                                    <a href="/client/list/news?id=<?= $AAA['id'] ?>" rel="bookmark"
                                                        class="td-image-wrap" title="<?= $AAA['title'] ?>">
                                                        <img width="218"
                                                            style="max-width: 100%;max-height: 150px;object-fit: cover;"
                                                            height="150" class="entry-thumb"
                                                            src="/img_file/<?= $AAA['avatar'] ?>"
                                                            sizes="(max-width: 218px) 100vw, 218px"
                                                            alt="<?= $AAA['title'] ?>" title="<?= $AAA['title'] ?>" />
                                                    </a>
                                                </div>
                                                <a href="/client/list/category?id=<?= $AAA['id_category'] ?>"
                                                    class="td-post-category">
                                                    <?php foreach ($categorys as $category) {
                                                            if ($category['id'] == $AAA['id_category']) {
                                                                echo $category['name'];
                                                            }
                                                        } ?>
                                                </a>
